...
namespace Microsoft.Practices.EnterpriseLibrary.Logging
{
    public class LogHelper
    {
        ...
        public const int DEFAULT_EVENTID = 100;
        public const string DEFAULT_CATEGORY = "System.ServiceModel";

        public static void Log(string message, string category, int priority, int eventID, TraceEventType eventType, string title)
        {
        ...
        {
            Logger.Write(message, DEFAULT_CATEGORY, DEFAULT_PRIORITY, DEFAULT_EVENTID, TraceEventType.Information, title);
        }

        public static void LogWarning(string message, string title)
        {
            Logger.Write(message, DEFAULT_CATEGORY, DEFAULT_PRIORITY, DEFAULT_EVENTID, TraceEventType.Warning, title);
        }

        public static void LogError(string message, string title)
        {
            Logger.Write(message, DEFAULT_CATEGORY, DEFAULT_PRIORITY, DEFAULT_EVENTID, TraceEventType.Error, title);
        }

        public static void Log(object serializableObject, string category, int priority, int eventID, TraceEventType eventType, string title)
        {
            Log(SerializeToString(serializableObject), category, priority, eventID, eventType, title);
        }

        public static void LogInformation(object serializableObject, string title)
        {
            LogInformation(SerializeToString(serializableObject), title);
        }

        public static void LogWarning(object serializableObject, string title)
        {
            LogWarning(SerializeToString(serializableObject), title);
        }

        public static void LogError(object serializableObject, string title)
        {
            LogError(SerializeToString(serializableObject), title);
        }
